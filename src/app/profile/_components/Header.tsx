    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center gap-[12px] px-[24px] py-[24px]">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="tp-title2-semibold relative mt-2 text-gray-400">
            #{profile.serialNumber}
            <span className="tp-body2-regular absolute left-1/2 top-8 flex w-fit -translate-x-1/2 whitespace-pre rounded-md bg-white px-3 py-2.5 text-gray-700 shadow-md">
              친구가 나를 찾을 수 있는 번호에요
            </span>
          </p>
        </div>
